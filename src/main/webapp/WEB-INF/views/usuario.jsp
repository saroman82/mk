...
<c:url var="addAction" value="/usuarios/crea" ></c:url>
...
<c:if test="${!empty listaUsuarios}">
	...
	<c:forEach items="${listaUsuarios}" var="usuario">
		<tr>
			...
			<td><a href="<c:url value='usuarios/edita/${usuario.id_user}' />" >Edita</a></td>
			<td><a href="<c:url value='usuarios/elimina/${usuario.id_user}' />" >Delete</a></td>
		</tr>
	</c:forEach>
	</table>
</c:if>
